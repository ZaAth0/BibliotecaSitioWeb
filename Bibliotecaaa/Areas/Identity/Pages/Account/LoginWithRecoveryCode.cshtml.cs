...
namespace Bibliotecaaa.Areas.Identity.Pages.Account
{
    public class LoginWithRecoveryCodeModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                _logger.LogWarning("Código de recuperación inválido ingresado para el usuario con ID '{UserId}' ", user.Id);
                ModelState.AddModelError(string.Empty, "Código de recuperación inválido ingresado.");
                return Page();
            }
        }
    }
