...
namespace Bibliotecaaa.Areas.Identity.Pages.Account.Manage
{
    public class GenerateRecoveryCodesModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            {
                throw new InvalidOperationException($"No se pueden generar códigos de recuperación para el usuario porque no tienen habilitada la autenticación de dos factores (2FA)");
            }
