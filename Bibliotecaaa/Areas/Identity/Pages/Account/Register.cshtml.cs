        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    // Agregar claims adicionales (FirstName, LastName, BirthDate) al usuario
                    ...
                    await _userManager.AddClaimAsync(user, new Claim("BirthDate", Input.BirthDate.ToString("yyyy-MM-dd")));
        ...
        private IdentityUser CreateUser()
        {
            ...
            catch
            {
                throw new InvalidOperationException($"No se puede crear una instancia de '{nameof(IdentityUser)}'. " +
                    ...
                    $"sobrescribir la página de registro en /Areas/Identity/Pages/Account/Register.cshtml");
            }
        }
