        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    portada = table.Column<string>(type: "varchar(255)", unicode: false, maxLength: 255, nullable: true),
                    ...
                    fecha_agregado = table.Column<DateTime>(type: "datetime", nullable: true, defaultValueSql: "(getdate())")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK__libros__EC09C24E6CECC7A8", x => x.id_libro);
                });
